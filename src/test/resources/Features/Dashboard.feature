...
Feature: Validate “Time at work” widgets display hours
...
Feature: Validate pending task in "My Actions"
...
Feature: Verify Dashboard Responsiveness on Mobile
...
Feature: Validate Pie Chart Display of Employee Locations
...
Feature: Verify the Help Button Redirects to the Support Page
...
Feature: Verify Dashboard Behavior After Session Timeout
...
Feature: Validate Widget Responsiveness on Tablet
...
Feature: Validate Notification Panel Collapses
...
Feature: Validate List of “Employees on Leave Today”
